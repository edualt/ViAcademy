      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              "assets/images/png/register_illustration.png",
            ),
            const SizedBox(height: 20),
            const RoundedInput(label: "Nombre completo", text: "Escribe tu nombre"),
            const SizedBox(height: 16),
            const RoundedInput(label: "Correo", text: "Escribe tu correo"),
            const SizedBox(height: 16),
            const RoundedInput(label: "Contraseña", text: "Escribe tu contraseña"),
            const SizedBox(height: 16),
            const RoundedInput(label: "Fecha de nacimiento", text: "Escribe tu fecha de nacimiento"),
            const SizedBox(height: 16),
            SizedBox(
